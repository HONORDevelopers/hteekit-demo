/*
* Copyright (c) Honor Device Co., Ltd. 2012-2019. All rights reserved.
* Description: 定义非安全客户端接口
* Create: 2012
*/
...
/*
 * TEEC_EXT_Tui_send_event
 * */
TEEC_Result TEEC_EXT_Tui_send_event(TEEC_TUI_Parameter *tuiParam);

static inline bool TEEC_Support()
{
    return (TEEC_GetTEEVersion() != TEEC_FAIL);
}
